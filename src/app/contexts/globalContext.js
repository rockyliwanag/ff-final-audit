        ...
        <GlobalContext.Provider value={
            {
                ...
                openProjectDetails, setOpenProjectDetails,
                openCE_Notes, setOpenCE_Notes,
                openContract, setOpenContract,
                openCR_Drive, setOpenCR_Drive,
                openSiteCapture, setOpenSiteCapture,
                openAurora, setOpenAurora,
                openFinance, setOpenFinance,
                auPanelQty, setAuPanelQty,
                auSysSize, setAuSysSize,
